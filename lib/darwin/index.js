...
function parseDisplaysOutput (json) {
  let displayinfos = []
  json.SPDisplaysDataType[0].spdisplays_ndrvs.forEach(key => {
      const temp = { name: key['_name'], primary: key['spdisplays_main'] === 'spdisplays_yes', displayId: parseInt(key['_spdisplays_displayID'], 16) }
